...
const Partners = () => {
    return (
        <>
            <section>
                <div className=''>
                    <h2 className='font_4xl color_white ff_lato fw-bolder mb-0 text-center pt-5 mb-0'>Part<span className=' color_orange'>ners</span></h2>
                </div>
                    ...
                    <div className='mycontainer py-md-5' >
                        <div className='py-sm-5'>
                            <div className='d-grid gap-4 align-items-center py-5 my_xxxl_5'>
                                <div className="grid_1 w-100 mt-5 mt-sm-0">
