...
import RightRoadMap1 from '../assets/img/png/RoadMapBallon.png'
import LeftRoadMap from '../assets/img/png/roadmapballonleft.png'
import RightRoadMap2 from '../assets/img/png/roadmapright.png'
    ...
    return (
        ...
        <MyNav/>
            <section className=' position-relative bg-black'>
                <img className='position-absolute end-0 top-0 RightRoadMap1' src={RightRoadMap1} alt="RightRoadMap1" />
                <img className='position-absolute  top-50 LeftRoadMap'  src={LeftRoadMap} alt="LeftRoadMap" />
                <img className='position-absolute end-0 bottom-0 RightRoadMap2' src={RightRoadMap2} alt="RightRoadMap2" />
                <h2 className='font_4xl color_white ff_lato fw-bolder mb-0 text-center py-5 mt-5'>Road<span className=' color_orange'>Map</span></h2>
                        ...
                        <Row className="CenterLine  position-relative ">
                            ...
                            <Col md={6}>
                                <div className="d-flex  position-relative">
                                    <img
                                        data-aos-delay="500" data-aos="zoom-in" className="BallonOne c_pointer transform_scale z-3 c_pointer transform_scale"
                                        src={Balloon1}
                                        alt="Balloon1"
                                    />
                                    <div data-aos-delay="500" data-aos="fade-left" className="right_line ps-5 ms-5 position-relative ">
                            ...
                            <Col md={6} >
                                <div className="d-flex justify-content-md-end position-relative mt-5 pt-5">
                                    <img
                                       data-aos-delay="500" data-aos="zoom-out" className="Ballontwo c_pointer transform_scale c_pointer transform_scale"
                                        src={Balloon2}
                                        alt="Balloon2"
                                    />
                                    <div data-aos-delay="500" data-aos="fade-right" className="left_line text-md-end position-relative ps-5 ps-md-0 ms-md-0 ms-5 pe-md-5 me-md-5">
                            ...
                            <Col md={6}>
                                <div className="d-flex  position-relative mt-5 pt-5">
                                    <img
                                        data-aos-delay="500" data-aos="zoom-in" className="BallonOne c_pointer transform_scale z-3 "
                                        src={Balloon3}
                                        alt="Balloon3"
                                    />
                                    <div data-aos-delay="500" data-aos="fade-left" className="right_line ps-5 ms-5 position-relative ">
                            ...
                            <Col md={6} >
                                <div className="d-flex justify-content-md-end position-relative mt-5 pt-5">
                                    <img
                                       data-aos-delay="500" data-aos="zoom-out" className="Ballontwo c_pointer transform_scale "
                                        src={Balloon4}
                                        alt="Balloon4"
                                    />
                                    <div data-aos-delay="500" data-aos="fade-right" className="left_line  text-md-end position-relative ps-5 ms-5  ps-md-0 ms-md-0 pe-md-5 me-md-5">
