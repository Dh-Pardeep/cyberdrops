...
const Hero = () => {
    return (
        <>
            <section>
                <div className='mycontainer pt-5 pb-lg-4 my-5'>
                    <Row className='justify-content-between py-5 my-md-3 align-items-center '>
                        <Col md={5} data-aos="fade-right" data-aos-delay="2000" data-aos-duration="800">
                            <div>
                                ...
                                <Link className='common_btn mt-4 mt-md-5 d-inline-block ff_lato font_lg color_white fw-semibold' data-aos="flip-left"data-aos-delay="2000" data-aos-duration="800" >Explore Now</Link>
                            </div>
                        </Col>
                        <Col md={6} lg={5} data-aos="fade-left" data-aos-delay="2000" data-aos-duration="800">
